...
| **Semana** | # ___ (Fecha: ___ al ___) |
| **Fase** | ___ (0: Onboarding / 1: Telemetría / 2: Visual 3D / 3: Display / 4: Demo) |
| **Practicante** | ___________________________ |

---

## 📋 Instrucciones

> Llena este reporte **cada viernes** antes de terminar tu jornada. Sé breve pero específico. Usa viñetas, no párrafos largos. El objetivo es que el CTO pueda leer tu reporte en **2 minutos** y entender exactamente dónde estás.
>
> **Copia esta template** y crea un archivo nuevo por semana: `sprint-semana-XX.md` (o usa el formato que el equipo prefiera).

---

## ✅ Lo que hice esta semana

> Lista las tareas completadas. Sé específico: menciona stories, PRs, archivos creados.

- [ ] **Story ___:** [Descripción breve de lo que hiciste]
- [ ] **Story ___:** [Descripción breve]
- [ ] [Otra tarea: review de PR, investigación, documentación, etc.]

**PRs creados/mergeados:**
- PR #___: [Título] — Estado: [abierto / mergeado / en review]

**Horas aproximadas trabajadas:** ___ h

---

## 🎯 Lo que haré la próxima semana

> Lista las tareas planeadas para la próxima semana. Alinéalas con el roadmap.

- [ ] **Story ___:** [Qué planeas hacer]
- [ ] **Story ___:** [Qué planeas hacer]
- [ ] [Otra tarea planeada]
...
> Lista cualquier cosa que te impida avanzar. Si no tienes bloqueos, escribe "Sin bloqueos".

| Bloqueo | Impacto | Necesito |
|---------|---------|----------|
| [Descripción del bloqueo] | [Qué no puedo hacer por esto] | [Qué necesitas para resolverlo] |

---

## 🆘 Lo que necesito

> Cualquier cosa que necesites del CTO, del otro practicante, o del equipo.

- [ ] [Acceso a algo / credencial / recurso]
- [ ] [Decisión técnica que necesita aprobación]
- [ ] [Feedback sobre algo específico]
- [ ] [Nada — todo bien 👍]
...
> Opcional pero valioso. ¿Descubriste algo interesante? ¿Algo fue más difícil o fácil de lo esperado? ¿Tienes sugerencias?

- [Lo que aprendí o descubrí esta semana]
- [Algo que mejoraría del proceso/código/docs]
- [Riesgo o preocupación que quiero señalar]
